...
var RNFS = {
  ...
  readFile(filepath: string, encodingOrOptions?: any, length = 0, offset = 0): Promise<string> {
    var options = {
      encoding: 'utf8'
    };
    ...
    return RNFSManager.readFile(normalizeFilePath(filepath), length, offset).then((b64) => {
      var contents;
